...
Esta é uma introdução visual básica aos conceitos por trás de um blockchain. Apresentamos a ideia de um livro razão imutável usando uma demonstração interativa da web.
...
```
git clone https://github.com/isaccanedo/blockchain.git
```
